...
class BKDailyKpi(Base):
    ...
    ca_drive: Mapped[float] = mapped_column(Numeric(14, 6), nullable=True)
    ca_drive_n1: Mapped[float] = mapped_column(Numeric(14, 6), nullable=True)
    client_drive: Mapped[int] = mapped_column(Integer, nullable=True)
    client_drive_n1: Mapped[int] = mapped_column(Integer, nullable=True)
